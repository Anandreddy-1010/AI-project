...
[!\[Python](https://img.shields.io/badge/Backend-Python%20/%20Jupyter-3776AB?style=flat-square&logo=python)](https://python.org)
...
* **Live Website:** https://anandreddy-1010.github.io/AI-project/
* **Run Cloud Notebook (Binder):** https://mybinder.org/v2/gh/Anandreddy-1010/AI-project/HEAD?filepath=MODEL.ipynb
* **View Notebook Online (nbviewer):** https://nbviewer.org/github/Anandreddy-1010/AI-project/blob/main/MODEL.ipynb
* **GitHub Repository:** https://github.com/Anandreddy-1010/AI-project
...
1. Open the [**Run Cloud Notebook**](https://mybinder.org/v2/gh/Anandreddy-1010/AI-project/HEAD?filepath=MODEL.ipynb) link above
...
Open the [**View Notebook Online**](https://nbviewer.org/github/Anandreddy-1010/AI-project/blob/main/MODEL.ipynb) link — good for a quick look at outputs without waiting for a live kernel.

### Option C — Visit the live website

The project also has a hosted landing page at [**anandreddy-1010.github.io/AI-project**](https://anandreddy-1010.github.io/AI-project/).

### Option D — Run locally

```bash
# Clone
git clone https://github.com/Anandreddy-1010/AI-project.git
cd AI-project
...
4. Optional: run `set\\\_email\\\_password()` in a new cell to enable real Gmail alerts
...
├── index.html               # Supporting frontend asset
├── requirements.txt          # Python dependencies
├── AIRES logo.png / AIRES\\\_LOGO.png / Project logo.jpg   # Branding assets
├── ttsMP3.com\\\_VoiceText\\\_\\\*.mp3   # Sample voice-guidance audio
├── assests/                 # Supporting assets
└── README.md
```
...
**Dayananda Sagar University** — Department of Computer Science \& Engineering (AIML)
